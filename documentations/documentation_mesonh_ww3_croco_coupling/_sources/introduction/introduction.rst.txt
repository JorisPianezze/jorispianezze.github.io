...
This documentation describes how to set up and run a coupled simulation between `Meso-NH <http://mesonh.aero.obs-mip.fr>`_ and `WW3 <https://polar.ncep.noaa.gov/waves/wavewatch>`_ and/or `CROCO <https://www.croco-ocean.org>`_ with the `OASIS <https://oasis.cerfacs.fr/en/home>`_ coupler. It doesn't contain detailed explanations on the use of Meso-NH, WW3, CROCO or OASIS. You are therefore advised to familiarise yourself with these models before reading this documentation.

.. warning::

   This documentation has been tested with version **5.7.2** of Meso-NH, version **2.1.0** of CROCO, version **7.14** of WW3 and version **5.2** of OASIS
...
.. note::
   ...
   Additional fields can be exchanged between CROCO and WW3 :cite:p:`porcile_2023`.
